...
public class MonitoringSystem {
   ...
   public static void main(String[] args) throws IOException {       
       ...
       while(true){
           ...
           System.out.println("\t3. Generate Animal Report");
           System.out.println("\t4. Generate Habitat Report");
           ...
           */
           ...
           case 2:
               ...
               break;
           case 3: 
        	 //Method function from class file "GenerateAnimalReport"
        	   GenerateAnimalReport.generateAnimalReport();
        	   break;
           case 4:
        	 //Method function from class file "GenerateHabitatReport"
        	   GenerateHabitatReport.generateHabitatReport();
        	   break;
           case 5:
